package com.casco.opgw.escalator.task;

import Ice.ObjectAdapter;
import SSIP.NEWS.*;
import com.casco.opgw.com.constant.ParamConstant;
import com.casco.opgw.escalator.OpgwEscalatorApplication;
import com.casco.opgw.escalator.observer.IceAnalogObserver;
import com.casco.opgw.escalator.observer.IceDigitObserver;
import com.casco.opgw.escalator.utils.PointCodeUtils;
...
public class InitPTask implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        File cfgFile =
                ResourceUtils.getFile( OpgwEscalatorApplication.global_params.get(ParamConstant.PARAM_KEY_SRVCONFIG));
