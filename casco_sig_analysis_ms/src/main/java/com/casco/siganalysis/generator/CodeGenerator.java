package com.casco.siganalysis.generator;
...
public class CodeGenerator {
    ...
    public static String moduleName = "siganalysis";

    public static String dbUrl = "jdbc:mysql://192.168.0.103:3306/casco_zhgs?useUnicode=true&useSSL=false&characterEncoding=utf8";
    public static String dbUserName = "root";
    public static String dbPassword = "Casco123";
